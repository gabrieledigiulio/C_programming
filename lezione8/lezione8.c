...
/* Translate the specified x,y grid point into the indes in 
 * to the linear array. This function implements wrapping, so
...
/*The functioon sets the specified cell at x, y to the specified state*/
...
/*Show the grid on the screen, cleaning the terminal using the
...
/*Return the number of the living cells neighbors of x,y */
...
int main(void) {
    ...
    //printf("%d\n", count_living_neighbors(old_grid, 10, 20));
